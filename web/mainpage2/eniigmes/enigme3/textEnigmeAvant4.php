<div class="det">
                 <p>Les enquêteurs sont entrés dans la chambre de Mouna et y ont trouvé le testament de la victime mais celui-ci ne contient aucun nom, il y est juste écrit au feutre noir : 
                  ...
                  <form action="index.php?enigme=4" method="POST" enctype="multipart/form-data">
                    <a href="famille.php"  target="_blank"><input type="button" value="telecharger" class="bt"></a>
                    <div  class="cent">
                      ...
                      if (isset($_POST['envoyerSolution'])) {
                        if(isset($_POST["solution"])){
                          if (strtolower($_POST["solution"]) == "rocky") {
                           echo '<script type="text/javascript">
                            window.location.href = \'index.php?enigme=4\';
                            </script>';
